    ...
    axios
      ...
      .then(response => {
        ...
        if (response.data._id) {
          ...
          let errorNameMsg = response.data.errors.userName
            ? response.data.errors.userName.message
            : "";
          let errorEmailMsg = response.data.errors.email
            ? response.data.errors.email.message
            : "";
          let errorPasswordMsg = response.data.errors.password
            ? response.data.errors.password.message
            : "";
          ...
          <Card className="create-act-card">
            ...
            <CardBody className="create-act-body">
              <Form className="create-act-form">
                <FormGroup>
                  <Label className="create-act-label" for="createUserName">
                    Name
                  </Label>
                  <Input
                    type="text"
                ...
                {this.state.errorNameMsg ? (
                  <p className="errormsg">{this.state.errorNameMsg}</p>
                ) : (
                  <p></p>
                )}
                <br></br>
                <FormGroup>
                  <Label className="create-act-label" for="createUserEmail">
                    Email
                  </Label>
                  <Input
                    type="email"
                ...
                {this.state.errorEmailMsg ? (
                  <p className="errormsg">{this.state.errorEmailMsg}</p>
                ) : (
                  <p></p>
                )}
                <br></br>
                <FormGroup>
                  <Label className="create-act-label" for="createUserPassword">
                    Password
                  </Label>
                  <Input
                    type="password"
                ...
                {this.state.errorPasswordMsg ? (
                  <p className="errormsg">{this.state.errorPasswordMsg}</p>
                ) : (
                  <p></p>
                )}
                <br></br>
